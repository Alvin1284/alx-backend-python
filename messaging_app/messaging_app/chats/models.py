...
class User(AbstractUser):
    ...
    password = models.CharField(
        _("password"), max_length=128, help_text=_("User's password (hashed)")
    )
    first_name = models.CharField(
        _("first name"), max_length=150, blank=True, help_text=_("User's first name")
    )
    last_name = models.CharField(
        _("last name"), max_length=150, blank=True, help_text=_("User's last name")
    )
...
class Message(models.Model):
    ...
    message_body = models.TextField(
        _("message body"), help_text=_("The content of the message")
    )
